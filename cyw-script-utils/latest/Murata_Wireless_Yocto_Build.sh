...
GITHUB_PATH="\""https://github.com/jameelkareem-pre-release-rocko/meta-murata-wireless.git"\""
META_MURATA_WIRELESS_GIT="https://github.com/jameelkareem-pre-release-rocko/meta-murata-wireless.git"
